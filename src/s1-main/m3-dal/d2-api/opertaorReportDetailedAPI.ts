...
export const operatorReportDetailedAPI = {
    getOperatorReportDetailedData(dateStart: string, timeStart: string, dateEnd: string, timeEnd: string) {
        return instance.get(`dashboard4?dtStart=${dateStart}T${timeStart}:59.000&dtStop=${dateEnd}T${timeEnd}:59.000`)
    }
}
