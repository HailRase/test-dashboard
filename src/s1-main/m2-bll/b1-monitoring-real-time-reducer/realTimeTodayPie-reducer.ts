...
const initialState:InitState = {
    data: [
        ...
        {name: 'Белтел Могилёвская', value: 1 /*totalCallReducer('GSM')*/, fill: '', index: 1},
        {name: 'Белтел Минская', value: 1 /*totalCallReducer('39-48-75')*/, fill: '', index: 2},
        {name: 'Белтел Гродненская', value: 1 /*totalCallReducer('39-25-47')*/, fill: '', index: 3},
        {name: 'Белтел Гомельская', value: 1 /*totalCallReducer('151 Other')*/, fill: '', index: 4},
        {name: 'Белтел Витебская', value: 1/*totalCallReducer('151 GSM')*/, fill: '', index: 5},
        {name: 'Белтел Брестская', value: 1/*totalCallReducer('151 Beltelecom')*/, fill: '', index: 6},
        {name: 'Repeat call', value: 1/*totalCallReducer('151 Beltelecom')*/, fill: '', index: 7},
        {name: 'MTC', value: 1/*totalCallReducer('105 Other')*/, fill: '', index: 14},
        {name: 'Life', value: 1 /*totalCallReducer('105 GSM')*/, fill: '', index: 15},
        {name: 'International', value: 1/*totalCallReducer('105 Beltelecom')*/, fill: '', index: 16},
        {name: 'A1', value: 1/*totalCallReducer('105 Beltelecom')*/, fill: '', index: 17},
    ],
