...
const SET_REAL_TIME_HISTOGRAM_ERROR = "SET_REAL_TIME_HISTOGRAM_ERROR"
...
type ActionDataType = ReturnType<typeof setRealTimeHistogramData> | ReturnType<typeof setStatus>
...
type InitState = {
    data: RealTimeHistogramDataType[],
    status: StatusType,
    errorMessage: string,
}
...
export const realTimeHistogramReducer = (state = initialState, action: ActionDataType) => {
    switch (action.type) {
        case SET_REAL_TIME_HISTOGRAM_DATA: {
            return {
                ...state,
                data: action.data
            }
        }
        case SET_REAL_TIME_HISTOGRAM_STATUS: {
            return {
                ...state,
                status: action.status
            }
        }
        case SET_REAL_TIME_HISTOGRAM_ERROR: {
            return {
                ...state,
